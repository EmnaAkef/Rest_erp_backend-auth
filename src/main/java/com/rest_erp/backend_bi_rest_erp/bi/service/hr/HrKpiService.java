package com.rest_erp.backend_bi_rest_erp.bi.service.hr;

import com.rest_erp.backend_bi_rest_erp.bi.dto.hr.*;
import com.rest_erp.backend_bi_rest_erp.bi.repository.CommonRepository;
import com.rest_erp.backend_bi_rest_erp.bi.repository.hr.HrKpiRepository;
...
public class HrKpiService {
    ...
    public List<AttendanceTrendItem> getAttendanceTrend(LocalDate startDate, LocalDate endDate, HrFilterRequest filters) {
        ...
        java.util.List<AttendanceTrendItem> result =
                new java.util.ArrayList<>();

        for (Object[] row : rows) {
            result.add(
                    AttendanceTrendItem.builder()
    ...
    public List<TenureDistributionItem> getTenureDistribution(HrFilterRequest filters) {
        ...
        java.util.List<TenureDistributionItem> result =
                new java.util.ArrayList<>();

        for (Object[] row : rows) {
            result.add(
                    TenureDistributionItem.builder()
                            .label(row[0] != null ? row[0].toString() : "")
    ...
    public List<SalaryBenchmarkItem> getSalaryBenchmarking(LocalDate startDate, LocalDate endDate, HrFilterRequest filters) {
        ...
        java.util.List<SalaryBenchmarkItem> result =
                new java.util.ArrayList<>();

        for (Object[] row : rows) {
            result.add(
                    SalaryBenchmarkItem.builder()
    ...
    public List<HiringFunnelItem> getHiringFunnel(LocalDate startDate, LocalDate endDate, HrFilterRequest filters) {
        ...
        java.util.List<HiringFunnelItem> result =
                new java.util.ArrayList<>();

        for (Object[] row : rows) {
            result.add(
                    HiringFunnelItem.builder()
    ...
    public List<UpcomingBirthdayItem> getUpcomingBirthdays(HrFilterRequest filters) {
        ...
        java.util.List<UpcomingBirthdayItem> result =
                new java.util.ArrayList<>();

        for (Object[] row : rows) {
            result.add(
                    UpcomingBirthdayItem.builder()
